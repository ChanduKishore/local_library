# Generated by Django 3.2.6 on 2021-08-11 01:40
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(help_text='enter name of the book (eg: pristage)', max_length=50)),
                ...
                ('summary', models.TextField(help_text='enter a breif summary of the book', max_length=1000)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='enter a Genre (ex:science fiction)', max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
